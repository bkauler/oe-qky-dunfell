...
# 20220719
DEPENDS_append_x86-64 = " lua luajit lua-native"
DEPENDS_append_aarch64 = " lua luajit lua-native"
...
# 20220719
EXTRA_OECONF_append_i686 = " --disable-lua"
EXTRA_OECONF_append_x86-64 = " --enable-lua"
EXTRA_OECONF_append_aarch64 = " --enable-lua"
