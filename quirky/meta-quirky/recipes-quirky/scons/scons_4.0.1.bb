...
RDEPENDS_${PN} += "python3-compression python3-core python3-crypt python3-ctypes python3-db python3-debugger python3-io python3-json python3-logging python3-lxml python3-math python3-netclient python3-pickle python3-pprint python3-profile python3-resource python3-shell python3-stringold python3-threading python3-unittest python3-xml"
