...
DEPENDS = "ffmpeg virtual/libgl gtk+ libsdl audacious glib-2.0 libsdl2 lame libxml2 faad2 dbus dbus-glib dbus-native dbus-glib-native libsndfile1 libnotify alsa-lib neon faac mpg123 libvorbis flac jack pulseaudio"

inherit pkgconfig gettext autotools-brokensep 

EXTRA_OECONF = "--with-libsdl=2 --with-ffmpeg=ffmpeg --with-system-libxml2=yes --enable-pulse --enable-notify --enable-alsa --enable-neon --enable-sndfile --enable-mpg123 --enable-vorbis --enable-flac --enable-jack"
