# 20221029 change vte to vte9, that uses gtk2
...
#BK 20201001 changed to gtk+2 and enabled vte

DEPENDS = "gtk+ libxml-parser-perl-native python3-docutils-native intltool-native vte9"
...
EXTRA_OECONF = "--disable-html-docs --disable-gtk3 --enable-vte"
